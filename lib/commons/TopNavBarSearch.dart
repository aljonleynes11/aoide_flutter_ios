...
class TopNavBarSearch extends StatefulWidget {
  final Widget screenBody;
  final Widget iconButton;
  final int activeIndex;
  TopNavBarSearch({this.screenBody, this.iconButton, this.activeIndex});

  @override
  _TopNavBarSearchState createState() => _TopNavBarSearchState();
}

var searchController = TextEditingController();
var _notifications;

class _TopNavBarSearchState extends State<TopNavBarSearch> {
  @override
  void initState() {
    super.initState();
            ...
            builder: (context, snapshot) {
              ...
              if (snapshot.hasError) {
                ...
                return Scaffold(
                  ...
                  body: SingleChildScrollView(child: widget.screenBody),
                  drawer: Drawer(
